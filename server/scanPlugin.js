...
function client() {
    if (!apiKey) {
        throw new Error("No ANTHROPIC_API_KEY. Add it to a .env file (see .env.example) and restart the dev server.");
    }
